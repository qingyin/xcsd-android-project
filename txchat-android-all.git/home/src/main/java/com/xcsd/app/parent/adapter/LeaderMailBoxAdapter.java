...
public class LeaderMailBoxAdapter extends ArrayAdapter<GardenMail> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.icon = (RoundImageView) convertView.findViewById(R.id.leader_mailbox_icon);
			viewHolder.content = (TextView) convertView.findViewById(R.id.leader_mailbox_content);
			viewHolder.time = (TextView) convertView.findViewById(R.id.leader_mailbox_time);
			viewHolder.name = (TextView) convertView.findViewById(R.id.leader_mailbox_name);
			viewHolder.isNew = (ImageView)convertView.findViewById(R.id.leader_mailbox_isnew);
			viewHolder.line = convertView.findViewById(R.id.leader_mailbox_line);
