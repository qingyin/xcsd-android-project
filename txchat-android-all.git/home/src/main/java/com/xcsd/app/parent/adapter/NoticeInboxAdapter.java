...
public class NoticeInboxAdapter extends ArrayAdapter<Notice> {
	...
	public NoticeInboxAdapter(Context context, List<Notice> notices) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(position < notices.size()) {
			...
			if (notice != null) {
				...
				viewHolder.wivHeadL.setImageUrl(notice.getSenderAvatar()+ SysConstants.Imgurlsuffix80, R.drawable.default_avatar);
