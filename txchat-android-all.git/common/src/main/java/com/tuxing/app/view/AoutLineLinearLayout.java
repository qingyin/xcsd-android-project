 ...
 * @version: V1.0
 */
public class AoutLineLinearLayout extends ViewGroup {
	int mLeft, mRight, mTop, mBottom;
	Hashtable map = new Hashtable();

	public AoutLineLinearLayout(Context context) {
	super(context);
	}

	public AoutLineLinearLayout(Context context, int horizontalSpacing, int verticalSpacing) {
	super(context);
	}

	public AoutLineLinearLayout(Context context, AttributeSet attrs) {
	super(context, attrs);
	}
