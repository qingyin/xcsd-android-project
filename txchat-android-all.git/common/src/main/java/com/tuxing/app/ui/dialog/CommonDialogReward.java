...
public class CommonDialogReward extends Dialog {
	...
	public CommonDialogReward(Context context) {
		this(context, R.style.dialog_common);
	}

	public CommonDialogReward(Context context, int defStyle) {
	...
	protected CommonDialogReward(Context context, boolean flag,
	...
	protected void init(final Context context) {
		...
		content = LayoutInflater.from(context).inflate(
				R.layout.dialog_common_ta, null);
		...
		if (!TextUtils.isEmpty(text)) {
			...
			negativeBt.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					if (listener != null)
						listener.onClick(CommonDialogReward.this, 0);
					else
						dismissClick.onClick(CommonDialogReward.this, 0);
				}
			});
