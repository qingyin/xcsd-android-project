 ...
 */
package com.tuxing.app.easemob.db;
	...
	public Map<String, User> getContactList() {
		...
		if (db.isOpen()) {
			...
			while (cursor.moveToNext()) {
				...
				if (username.equals(SysConstants.NEW_FRIENDS_USERNAME) || username.equals(SysConstants.GROUP_USERNAME)
				        || username.equals(SysConstants.CHAT_ROOM)) {
					user.setHeader("");
