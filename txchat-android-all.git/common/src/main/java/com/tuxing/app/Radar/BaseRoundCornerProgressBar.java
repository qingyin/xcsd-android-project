...
import com.tuxing.app.util.DisplayUtils;
...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    protected abstract void drawProgress(LinearLayout layoutProgress, float max, float progress, float totalWidth,
                                         float radius, float padding, int colorProgress, boolean isReverse);
    ...
    public void setupStyleable(Context context, AttributeSet attrs) {
        ...
        radius = (float) typedArray.getDimension(R.styleable.RoundCornerProgress_rcRadius, dp2px(DEFAULT_PROGRESS_RADIUS));
        padding = (float) typedArray.getDimension(R.styleable.RoundCornerProgress_rcBackgroundPadding, dp2px(DEFAULT_BACKGROUND_PADDING));
...
//        int colorProgressDefault = context.getResources().getColor(R.color.round_corner_progress_bar_progress_default);
        int colorProgressDefault = context.getResources().getColor(R.color.gray_line);
    ...
    private void drawBackgroundProgress() {
        ...
        float newRadius = radius - (padding / 2f);
    ...
    private void drawPadding() {
        layoutBackground.setPadding((int)padding, (int)padding, (int)padding, (int)padding);
    }
