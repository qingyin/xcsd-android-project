...
import com.tuxing.app.easemob.DefaultHXSDKModel;
import com.tuxing.app.easemob.db.DbOpenHelper;
import com.tuxing.app.easemob.db.UserDao;
import com.tuxing.app.easemob.domain.User;

import java.util.List;
import java.util.Map;

public class TuxingHXSDKModel extends DefaultHXSDKModel {

    public TuxingHXSDKModel(Context ctx) {
        super(ctx);
    }
