...
public class GestureImageView extends ImageView  {
	...
	public boolean imageCanDragX(){
		return gestureImageViewTouchListener.imageCanDragX();
	}
	...
	protected void setupCanvas(int measuredWidth, int measuredHeight, int orientation) {
		Log.e("GestureImageView", "setupCanvas");
		if(deviceOrientation != orientation) {
			Log.e("GestureImageView", "layout = false;");
			layout = false;
...
//			}
			...
			Log.e("GestureImageView", "layout = true;");
			layout = true;
		}
	}
	...
	protected void computeStartingScale(int imageWidth, int imageHeight, int measuredWidth, int measuredHeight) {
		Log.e("GestureImageView", "computeStartingScale getScaleType="+getScaleType());
		switch(getScaleType()) {
			case CENTER:
	...
	protected void initImage() {
		...
		Log.e("GestureImageView", "initImage layout = false");
		startX = null;
		startY = null;
		startingScale = -1.0f;
