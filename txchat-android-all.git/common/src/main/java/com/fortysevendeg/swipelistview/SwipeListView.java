...
public class SwipeListView extends XListView {
    ...
    public void dismiss2(int position){
    	touchListener.dismiss2(position);
    }
    ...
    protected void onActionDown(View v, MotionEvent event){
        if (swipeListViewListener != null) {
             swipeListViewListener.onActionDown(v, event);
        }
    }
    ...
    private void checkInMoving(float x, float y) {
        ...
        if (xMoved) {
            ...
            Log.d("SwipeListView", "checkInMoving touchState = TOUCH_STATE_SCROLLING_X");
        }
        ...
        if (yMoved) {
            ...
            lastMotionX = x;
            lastMotionY = y;
            Log.d("SwipeListView", "checkInMoving touchState = TOUCH_STATE_SCROLLING_Y");
        }
    }
