...
public class MediaRecorderNative extends MediaRecorderBase implements MediaRecorder.OnErrorListener {
	...
	public MediaPart startRecord() {
		...
		if (mMediaObject != null) {
			...
			cmd += String.format("addcmd = %s; "," -vf \"transpose=1,crop=480:360:0:0\" ");
	...
	protected void onStartPreviewSuccess() {
		...
		UtilityAdapter.RenderOutputSettings(360, 480, mFrameRate, UtilityAdapter.OUTPUTFORMAT_YUV | UtilityAdapter.OUTPUTFORMAT_MASK_MP4 /*| UtilityAdapter.OUTPUTFORMAT_MASK_HARDWARE_ACC*/);
	}
